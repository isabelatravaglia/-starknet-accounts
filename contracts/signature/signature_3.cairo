...
func _is_valid_eth_signature{
    ...
    //
    let sig_v: felt = signature[0];// CODE HERE
    let sig_r: Uint256 = Uint256(low=signature[1], high=signature[2]);// CODE HERE
    let sig_s: Uint256 = Uint256(low=signature[3], high=signature[4]);// CODE HERE
    let (high, low) = split_felt(hash);// CODE HERE
    let msg_hash: Uint256 = Uint256(low=low, high=high);// CODE HERE
